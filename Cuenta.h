...
// Operación de obtención de colaPagos
// Precondicion: cuenta debe haberse creado
// Postcondición: se obtiene la cola de pagos
// Parámetros:
// cuenta: TDACuenta del que se obtiene colaPagos
// Devuelve un puntero a cola representando la colaPagos
PtrCola getColaPagos(CuentaPtr cuenta);

// Operación de asignación de colaPagos
// Precondicion: cuenta debe haberse creado
// Postcondición: cuenta cambia con el nuevo valor de colaPagos
// Parámetros:
// cuenta: TDACuenta al que se asignara el nuevo valor de colaPagos
// colaPagos: puntero a cola representando el nuevo valor de colaPagos
// No devuelve valor.
