...
// Parámetros:
// movimientos: TDAMovimientos al que se asignara el nuevo valor de idTipoMov
// idTipoMov: char representando el nuevo valor de idTipoMov
// No devuelve valor.
void setIdTipoMov(MovimientosPtr movimientos, char idTipoMov[3]);

// Operación de obtención de descripcion
// Precondicion: movimientos debe haberse creado
// Postcondición: se obtiene la descripcion del movimiento
// Parámetros:
// movimientos: TDAMovimientos del que se obtiene la descripcion de movimiento
// Devuelve un char representando la descripcion de movimiento
char* getDescripcion(MovimientosPtr movimientos);

// Operación de asignación de descripcion
// Precondicion: movimientos debe haberse creado
// Postcondición: movimientos cambia con el nuevo valor de descripcion
// Parámetros:
// movimientos: TDAMovimientos al que se asignara el nuevo valor de descripcion
// descripcion: char representando el nuevo valor de descripcion
// No devuelve valor.
void setDescripcion(MovimientosPtr movimientos, char descripcion[50]);
...
// Parámetros:
// movimientos: TDAMovimientos al que se asignara el nuevo valor de monto
