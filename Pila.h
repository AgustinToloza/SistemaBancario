...
// Operación de desapilado a pila
// Precondicion: la pila debe haber sido creada.
// Postcondición: Se elimina el ultimo nodo insertado de la pila
// Parámetros:
//  pila: puntero a la pila
// Devuelve puntero al dato del nodo desapilado
PtrDato desapilar(PtrPila pila);

// Operación de obtención del primero de la pila
// Precondicion: la pila debe haber sido creada.
// Postcondición: Se obtiene el dato del primer nodo sin desapilarlo
// Parámetros:
//  pila: puntero a la pila
// Devuelve puntero al dato de la primera posición
PtrDato primeroPila(PtrPila pila);

// Operación de obtención de nodo
// Precondicion: la pila debe haber sido creada.
// Postcondición: Se obtiene el nodo indicado
// Parámetros:
//  pila: puntero a la pila
//  posicion: entero representando la posicion a obtener
// Devuelve puntero al nodo indicado
PtrNodo getNodoPila(PtrPila pila, int posicion);

// Operación de obtención de dato
// Precondicion: la pila debe haber sido creada.
// Postcondición: Se obtiene el dato del nodo indicado
// Parámetros:
//  pila: puntero a la pila
//  entero: representando la posicion a obtener
// Devuelve puntero al dato del nodo indicado
